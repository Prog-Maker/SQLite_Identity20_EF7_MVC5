...
namespace Identity.SQLite
{
    ...
    public class RoleRepository
    {
        ...
        {
            return _identityEntities.AspNetRoles as IQueryable<TRole>;
        }
        ...
        public async Task DeleteRoleAsync(string roleId)
        {
            ...
            {
                AspNetRoles currentRole = await _identityEntities.AspNetRoles.SingleOrDefaultAsync(role => role.Id == roleId);

                if (currentRole != null)
                {
                    _identityEntities.AspNetRoles.Remove(currentRole);
        ...
        public async Task AddNewRoleAsync(IdentityRole role)
        {
            if (role != null)
            {
                _identityEntities.AspNetRoles.Add(new AspNetRoles
                {
                    Id = role.Id,
                    Name = role.Name
                });
        ...
        public async Task<string> GetRoleIdAsync(string roleName)
        {
            ...
            {
                AspNetRoles currentRole = await _identityEntities.AspNetRoles.SingleOrDefaultAsync(role => role.Name.ToUpper() == roleName.ToUpper());
                if (currentRole != null)
                {
        ...
        public async Task UpdateRoleAsync(IdentityRole role)
        {
            if (role != null)
            {
                AspNetRoles currentRole = await _identityEntities.AspNetRoles.SingleOrDefaultAsync(userRole => userRole.Id == role.Id);
                if (currentRole != null)
                {
